...
public class PerformanceLoggingKits {
     ...
     */
    private static ThreadLocal<Timer> localTimer = ThreadLocal.withInitial(() -> new Timer());

    /**
     * 按Key定义多个ThreadLocal Timer
     */
    private static ThreadLocal<Map<String, Timer>> localTimerMap = ThreadLocal.withInitial(() -> new HashMap<>());
